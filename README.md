...
[![MockUp](https://github.com/user-attachments/assets/27dfd210-a01f-49ea-9d58-93648930619e)](https://re-view.my/)
...
리뷰형 커뮤니티 서비스인 **Re|view**는 사용자들이 보고 느낀 모든 경험을 바탕으로 리뷰를 작성하고 공유할 수 있는 새로운 리뷰 플랫폼입니다.

영화, 게임, 음악, 책, 맛집 어떤 경험이든 상관 없습니다. 당신의 경험에 대한 감상을 **다시(Re) 반추한 내용이 담긴 영역**과 그 경험을 **보여주는(view) 이미지가 담긴 영역**을 모두 담은 **리뷰카드**를 통해 다른 사용자와 당신의 경험을 공유해보세요!
...
[![React Router](https://img.shields.io/badge/React%20Router-CA4245?style=flat-square&logo=React%20Router&logoColor=white)](https://reactrouter.com/)
[![TailwindCSS](https://img.shields.io/badge/TailwindCSS-06B6D4?style=flat-square&logo=TailwindCSS&logoColor=white)](https://tailwindcss.com/)

[![Vite](https://img.shields.io/badge/Vite-646CFF?style=flat-square&logo=Vite&logoColor=white)](https://vitejs.dev/)
[![React Query](https://img.shields.io/badge/Tanstack%20Query-FF4154?style=flat-square&logo=React%20Query&logoColor=white)](https://tanstack.com/query)
...
[![AWS Lambda](https://img.shields.io/badge/AWS%20Lambda-FF9900?style=flat-square&logo=AWS%20Lambda&logoColor=white)](https://aws.amazon.com/lambda/)
[![AWS S3](https://img.shields.io/badge/AWS%20S3-569A31?style=flat-square&logo=AWS%20S3&logoColor=white)](https://aws.amazon.com/s3/)
...
<img alt="리뷰카드" src="https://github.com/user-attachments/assets/c9b46be8-975e-437e-97e4-22bfeaa66a3d" width="320px">

사용자가 작성한 리뷰 내용과 이미지를 한번에 볼 수 있는 인터렉티브한 리뷰카드와 함께 작성된 리뷰들을 볼 수 있습니다. 좋은 리뷰에는 추천 버튼을 눌러 추천해보세요!

#### Mobile 화면

<img alt="모바일 홈" src="https://github.com/user-attachments/assets/57d7f1b4-f1e6-42c6-b77a-8ec08f4cae4d" width="320px">

#### Desktop 화면

<img alt="데스크톱 홈" src="https://github.com/user-attachments/assets/d447e9e0-b7ee-421d-a8c6-779d136722e3" width="640px">

### 📌 태그 및 검색

<img alt="검색" src="https://github.com/user-attachments/assets/99ece71c-2afd-45b2-8b60-556e8dffeb48" width="640px">

리뷰의 태그를 클릭하거나, 검색 버튼을 눌러 키워드를 입력해 키워드에 맞는 리뷰를 검색할 수 있습니다.

### 📌 프로필

<img alt="내가 쓴 리뷰" src="https://github.com/user-attachments/assets/db003b09-c9d9-458f-9bdf-a75359d92a58" width="640px">

<img alt="내가 작성한 댓글" src="https://github.com/user-attachments/assets/715616d2-5a1c-4fd8-add7-37dcbf257de4" width="640px">

<img alt="내가 추천한 리뷰" src="https://github.com/user-attachments/assets/e2ba2e36-2aa9-46ea-8cb4-7eb5fd553d21" width="640px">

사용자의 프로필 페이지에서 해당 사용자가 작성한 리뷰, 작성한 댓글, 추천한 리뷰를 볼 수 있습니다.

### 📌 리뷰 작성

<img src="https://image.re-view.my/%EB%A6%AC%EB%B7%B0%20%EC%9E%91%EC%84%B1.webp" width="320px">

리뷰 작성 페이지에서 리뷰를 작성할 수 있습니다. 업로드한 이미지들은 모두 webp 형식으로 변환되어 서버측에 저장됩니다.
